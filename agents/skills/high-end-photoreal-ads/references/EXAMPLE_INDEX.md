...
Layout and photography patterns only. Files live in [`examples/`](examples/).  
**Do not** invent brand claims, agency credits, or portfolio attributions for these refs.  
**Do not** copy real-brand trade dress from examples into F&P campaign pixels — use Campaign DNA + locked refs for product identity.

| File | Mode | Pattern taught |
| --- | --- | --- |
| `examples/01-editorial-fashion.jpg` | `editorial-fashion` | Large brand/display type behind or beside the subject; editorial grid; solid CTA button; monochrome / limited palette; photoreal fashion subject |
