---
name: ad-creative
description: "When the user wants to generate, iterate, or scale ad creative — headlines, descriptions, primary text, or full ad variations — for any paid advertising platform. Also use when the user mentions 'ad copy variations,' 'ad creative,' 'generate headlines,' 'RSA headlines,' 'bulk ad copy,' 'ad iterations,' 'creative testing,' 'write me some ads,' 'Facebook ad copy,' 'Google ad headlines,' 'LinkedIn ad text,' 'static ads,' 'ad templates,' 'iMessage ad,' 'chat reveal ad,' 'ChatGPT ad,' 'Apple Notes ad,' 'AirDrop ad,' 'creative strategy,' 'creative roadmap,' 'creative retro,' 'hook writing,' 'creative review page,' 'present ad creative for approval,' 'motion video ad,' 'faceless video ad,' 'UGC ad,' 'greenscreen ad,' 'TikTok/Reels ad format,' 'which ad format to make,' 'Meta ad format tier list,' or 'creative format taxonomy.' Use this whenever someone needs to produce ad copy at scale or iterate on existing ads. For landing page copy, see copywriting. (Upstream `ads` campaign-strategy skill is not in this lean F&P pull.)"
metadata:
  version: "2.8.2-fp"
---

> **F&P Studio note:** This is a **strategy/copy framework** adapted from [coreyhaines31/marketingskills](https://github.com/coreyhaines31/marketingskills) (MIT). For finished photoreal statics use [`high-end-photoreal-ads`](../high-end-photoreal-ads/) + [`ORIGINALITY.md`](../ORIGINALITY.md). AdScoop / Meta Library research uses [`adscoop-to-fp-handoff`](../adscoop-to-fp-handoff/). Do **not** weaken originality — frameworks and patterns only; invent original packs/lines grounded in Campaign DNA. Attribution: [`../marketingskills-ATTRIBUTION.md`](../marketingskills-ATTRIBUTION.md).
...
## Tool Integrations (F&P lean)

Upstream marketingskills ships Ads CLI integrations under `tools/` — **not vendored** in this F&P pull. Paste performance CSVs/exports from the ad platforms, or use whatever analytics the campaign already has. Do not invent metrics.

**Finished visual production** is not this skill’s job here:

- Photoreal finished statics → [`../high-end-photoreal-ads/`](../high-end-photoreal-ads/) + [`../ORIGINALITY.md`](../ORIGINALITY.md)
- General static image ads → [`../generating-image-ads/`](../generating-image-ads/)
- Ad videos → [`../generating-ad-videos/`](../generating-ad-videos/)
- AdScoop research handoff → [`../adscoop-to-fp-handoff/`](../adscoop-to-fp-handoff/)

### Workflow: Pull Data, Analyze, Generate

1. Export recent ad performance from the platform (CSV / dashboard)
2. Identify top/bottom performers and winning angles
3. Feed those patterns into this skill for new copy/concept variations
4. For finished photoreal frames, hand off to `high-end-photoreal-ads` / F&P Generate — do not weaken originality

---

## Related Skills

- **product-marketing**: Foundation context (`.agents/product-marketing.md` / Campaign DNA)
- **copywriting**: Landing page copy (where ad traffic lands)
- **high-end-photoreal-ads** / **generating-image-ads** / **generating-ad-videos**: F&P finished creative production
- **adscoop-to-fp-handoff**: Meta Library / AdScoop research → DNA (swipe principles only)
- Upstream-only (not in this tree): `ads`, `marketing-loops`, `customer-research`, `ab-testing`, `marketing-psychology`, `copy-editing`
