...
To run this loop on a schedule (retro on the 1st, weekly refresh Mondays, daily batches via Mode 3), calendar it yourself (upstream `marketing-loops` is not vendored in this lean F&P pull).
