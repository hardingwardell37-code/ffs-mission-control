...
- **Job Operator Phase 0** — marketplace-agnostic job intake data model (`studio_jobs`, brief analysis, workflows, revisions). Schema + domain only; no kanban UI yet. See `docs/JOB_OPERATOR_PHASE0.md`.
...
2. Apply migrations `0001`, `0002`, `0003_campaign_core.sql`, `0004_studio_bootstrap.sql`, `0005_generation_jobs.sql`, `0006_runway_provider.sql`, then `0007_studio_jobs.sql` (SQL editor or CLI).
