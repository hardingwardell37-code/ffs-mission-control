...
export default async function HomePage(){
  ...
  return <>
    <div className="eyebrow">Personal production studio · Phase 0</div>
    <h1>Research to approval — Wardell remains final creative authority.</h1>
    <p className="lede">F&amp;P Studio is the operating surface for campaign work, governed agents, tasks, approvals, and execution history. Phase 0 stabilizes the existing control plane before campaign workspace and media pipelines land.</p>
